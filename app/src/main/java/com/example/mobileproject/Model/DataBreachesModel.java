...
public class DataBreachesModel {
...
*/
    ...
    public DataBreachesModel(String Name, String Title, String Domain, Integer PwnCount, String Description, String[] DataClasses, boolean IsVerified, boolean IsFabricated, boolean IsSensitive, boolean IsRetired, boolean IsSpamList, String LogoPath)
    {
        this.Name = Name;
        this.Title = Title;
        this.Domain = Domain;
